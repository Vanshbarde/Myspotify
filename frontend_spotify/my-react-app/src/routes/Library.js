...
const LoggedinHome= () => {
  ...
  Vansh
        ...
        <div className='text-white pt-5 pl-5 text-lg font-bold'>
        Your Library
        </div>
      </div>
      </div>
      {/* //this div is for the current song playing  */}
      {/* <div className='w-full h-1/10 bg-black text-white flex items-center  px-4 '>
       <div className='w-1/3 flex items-center'>
        <img className='h-16 w-16 rounded'  src='https://plus.unsplash.com/premium_photo-1725708358944-844db020a73a?w=1000&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxmZWF0dXJlZC1waG90b3MtZmVlZHwxfHx8ZW58MHx8fHx8'/>
       <div className='pl-4'>
       ...
       <div className='w-1/2 flex justify-center hover:underline cursor-pointer 
       h-full flex-col items-center'>
        <div className=' w-1/3 flex justify-between items-center '>
          <Icon icon="mdi:shuffle" fontSize={27}  
          className='cursor-pointer text-gray-400 hover:text-white'/>
          <Icon icon="mdi:skip-previous"  fontSize={27}
           className='cursor-pointer text-gray-400 hover:text-white'/>
          <Icon icon= {isPaused?"mdi:pause" : "mdi:play"}  
          fontSize={32}
           className='cursor-pointer text-gray-400 hover:text-white'
           onClick={togglePlayPause}/> 
          <Icon icon="mdi:skip-next"  fontSize={27}
           className='cursor-pointer text-gray-400 hover:text-white'/>
          <Icon icon="mdi:repeat"  fontSize={27}
           className='cursor-pointer text-gray-400 hover:text-white'/>
          </div>
